...
states <- read.delim("COVID_hosp_analysis/states_COVID_hosp_analysis.tsv", header = FALSE)$V1
...
load(bestfit_path) # ss_fit and seed_sh
resamp <- readRDS(boot_path) # load from bootstrapped parameter values
