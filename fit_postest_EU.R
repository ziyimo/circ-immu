...
all_state_sun <- read.csv("state_lv_data/US_sunrise_2019.csv")
all_state_day <- read.csv("state_lv_data/US_daytime_2019.csv")
all_state_hum <- read.csv("state_lv_data/US_humidity_2010_18.csv")
all_state_tmp <- read.csv("state_lv_data/US_temperature_2010_18.csv")
