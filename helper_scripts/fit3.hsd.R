...
for (iter in seq(20)){
  ...
  cat(">> ", unlist(ss_fit), "\n>> ", seed_sh, "\n")
  save(ss_fit, seed_sh, file = paste0("fit_results/", handle,"_iter",iter, "_iterative.fit3h.rds"))
}

save(ss_fit, seed_sh, file = paste0("fit_results/", handle, "_iterative.fit3h.rds"))
stopCluster(clstr)
